...
useHead({
  ...
  meta: $prepareMeta({
    title: "Abrar's Blog",
    description:
      "Abrar'nin günlük hayattan, tecrübelerinden bahsettiği, göstermek veya anlatmak istediği şeyleri daha düzenli ve profesyonel bir şekilde tuttuğu blog sayfası.",
  }),
})
